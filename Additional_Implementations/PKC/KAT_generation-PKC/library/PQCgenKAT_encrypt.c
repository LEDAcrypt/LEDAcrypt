...
main()
{
   ...
   sprintf(fn_req, "../../../KAT/Reference_KAT/PQCencryptKAT_%d_%d.req",
           (int)CRYPTO_SECRETKEYBYTES,DFR_SL_LEVEL);
   if ( (fp_req = fopen(fn_req, "w")) == NULL ) {
      printf("Couldn't open <%s> for write\n", fn_req);
      return KAT_FILE_OPEN_ERROR;
   }
   sprintf(fn_rsp, "../../../KAT/Reference_KAT/PQCencryptKAT_%d_%d.rsp",
           (int)CRYPTO_SECRETKEYBYTES,DFR_SL_LEVEL);
